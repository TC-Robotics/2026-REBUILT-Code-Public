...
public record ChoreoTraj(
    ...
    public static final ChoreoTraj traj_1_1start = new ChoreoTraj(
	    "traj_1_1start",
	    OptionalInt.empty(),
	    1.44438,
	    new Pose2d(3.917, 7.245, Rotation2d.fromRadians(0)),
	    new Pose2d(8.237, 6.919, Rotation2d.fromRadians(-1.571))
	);
	public static final ChoreoTraj traj_1_2return = new ChoreoTraj(
	    "traj_1_2return",
	    OptionalInt.empty(),
	    3.744,
	    new Pose2d(8.237, 6.919, Rotation2d.fromRadians(-1.571)),
	    new Pose2d(0.467, 0.698, Rotation2d.fromRadians(0))
	);
    ...
    public static final Map<String, ChoreoTraj> ALL_TRAJECTORIES = Map.ofEntries(
    	Map.entry("traj_1_1start", traj_1_1start),
		Map.entry("traj_1_2return", traj_1_2return)
    );
