...
public class Drive extends SubsystemBase {
    ...
    public Drive(
        ...
        AutoBuilder.configure(
                ...
                (ChassisSpeeds speeds, DriveFeedforwards ff) -> runVelocity(speeds, ff),
    ...
    public void periodic() {
        ...
        for (int i = 0; i < sampleCount; i++) {
            ...
            if (gyroInputs.connected) {
                ...
                Rotation3d yaw3d = gyroInputs.odometryYawPositions[i];
                rawGyroRotation = new Rotation3d(0.0, 0.0, yaw3d.getZ());
            } else {
                // Use the angle delta from the kinematics and module deltas
                Twist2d twist = kinematics.toTwist2d(moduleDeltas);
                rawGyroRotation = rawGyroRotation.plus(new Rotation3d(0.0, 0.0, twist.dtheta));
            }
