...
public class ModuleIOSim implements ModuleIO {
  ...
  private static final Vector<N3> Z_ROT = VecBuilder.fill(0, 0, 1);
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    ...
    inputs.turnAbsolutePosition = new Rotation3d(Z_ROT, turnSim.getAngularPositionRad());
    inputs.turnPosition = new Rotation3d(Z_ROT, turnSim.getAngularPositionRad());
    ...
    inputs.odometryTurnPositions = new Rotation3d[] { inputs.turnPosition };
  }
  ...
  @Override
  public void setTurnPosition(Rotation3d rotation) {
    turnClosedLoop = true;
    turnController.setSetpoint(rotation.getZ());
  }
}